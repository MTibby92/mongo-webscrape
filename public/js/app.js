$( document ).ready(function() {
    ...
    $('#upload-icon').on('click', function(event) {
        ...
        // check if anything was entered into the text area; do nothing if empty
        if (!$('#note-area').val().trim()) {
    ...
    $('#remove-icon').on('click', function(event) {
        ...
        // check if there's a note displayed; do nothing if there's no note there
        if(!noteID) {
